...
### Loss Function 
The next step is to choose and implement a loss function. The loss function measures how inaccurate a model is for a single example. Training a model minimizes the loss function. Mean squared errors is a common loss function for regression. Cross entropy (aka log loss, negative log probability) is a common loss function for the softmax activation function in classification models.   
