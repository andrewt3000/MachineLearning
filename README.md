...
- **Training**: The model learns from data — adjusting its parameters to minimize [error](neuralNets.md#loss-function) (supervised learning) or maximize reward (RL). This phase is computationally expensive and done offline.
